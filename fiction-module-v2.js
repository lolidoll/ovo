...
请简要列举5-8个最火的题材/特点，格式为：题材名称 - 特点描述`;
            ...
            const generatePrompt = `你不是一个成功的小说家，你甚至都不太会写小说。你没有华丽的文笔，也不会堆砌词藻，你只是一个对写作有兴趣的普通人。你不懂什么写作技巧，你只是喜欢观察生活，喜欢讲故事。你用最朴素的语言，像跟朋友聊天一样，把你看到的、想到的写出来。你不必追求完美，不用为了完成任务去写作。好好享受写作的过程，你就是想把这个故事说给别人听，写到哪算哪，让故事自己流淌出来。
...
- 要有同人文的感觉：基于这两个角色进行二次创作，赋予这两个角色角色新的故事和命运，发挥创意和脑洞
...
(2) 人物塑造：创造复杂、有深度的人物，尤其是主角间的性格和成长过程。
...
(2) 人物塑造：创造复杂、有深度的人物，尤其是主角间的性格和成长过程。深挖人物过去的经历，原生家庭，以便形成立体的人物形象，解释人物在小说中的行为与性格。
(3) 对话技巧：写出自然、真实的对话，增强人物的真实性和情感的表达。
...
- 散文化的美文写法
- 为了完成任务而写作
根据以下信息，重新创作小说《${book.title}》的第${chapterIdx + 1}章。
...
主角名：${charName}，TA的角色设定参考：${charDescription || '暂无详细设定'}
主角名：${userName}，TA的角色设定参考：${userDescription || '暂无详细设定'}
