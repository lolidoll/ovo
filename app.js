...
记住：表情包是情绪表达工具，图片是视觉内容；处理时方式完全不同。`);
        ...
        function renderEmojiMgmtGroups() {
            ...
            addBtn.style.cssText = 'width:24px;height:24px;border:1px solid #ddd;border-radius:4px;background:#fff;cursor:pointer;font-size:16px;padding:0;display:flex;align-items:center;justify-content:center;transition:all 0.2s;color:#666;';
            addBtn.textContent = '+';
            addBtn.title = '新增分组';
